...
public class CommentController {
    ...
    public Comment addComment(Principal principal, @PathVariable int id, @RequestBody CreateOrUpdateComment comment) {
    ...
    public Comment updateComment(Principal principal, @PathVariable int id, @PathVariable int commentId, @RequestBody CreateOrUpdateComment comment) {
